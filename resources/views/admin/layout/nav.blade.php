...
<li class="has_sub">
    <a href="javascript:void(0);" class="waves-effect"><i class="zmdi zmdi-view-list"></i> <span> المدن </span> <span
...
<li>
    <a href="{{ route('admin.offers.index') }}" class="waves-effect"><i class="zmdi zmdi-collection-item"></i> <span> العروض </span>
    </a>
</li>
<li>
    <a href="{{ route('admin.requests.index') }}" class="waves-effect"><i class="zmdi zmdi-collection-item"></i> <span> الطلبات </span>
    </a>
</li>
