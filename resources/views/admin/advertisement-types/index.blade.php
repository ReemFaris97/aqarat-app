    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="header-title m-t-0 m-b-30">كل انواع الاعلانات</h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    @foreach($items as $key=>$item)
                        <tr>
                            ...
                            <td>{{$item->name}}</td>
                            <td>
                                    <a href="{{route('admin.advertisement-types.edit',$item->id)}}"
                                       class="btn btn-info btn-circle"><i style="padding-top:5px;padding-left: 6px;"
                                                                          class="fa fa-pencil"></i></a>

                                    <a data-url="{{ route('admin.advertisement-types.destroy', $item) }}"
